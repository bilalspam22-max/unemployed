...
export const DEMO_FOLLOWUPS = [
  { id: "fu1", userId: "demo", contactId: "ct1", scheduledDate: "2026-05-20", status: "completed" as const, messageTemplateUsed: "Relance post-entretien", myMessage: "Bonjour Sophie,\n\nSuite à notre entretien de la semaine dernière, je voulais vous remercier pour l'échange. Avez-vous eu le temps de discuter de ma candidature avec l'équipe ?\n\nCordialement", interlocutorResponse: "Bonjour ! Oui on en a discuté, je reviens vers vous d'ici la fin de semaine avec un retour de l'équipe technique.", completedAt: "2026-05-20", createdAt: new Date("2026-05-15") },
  { id: "fu2", userId: "demo", contactId: "ct3", scheduledDate: "2026-05-25", status: "completed" as const, messageTemplateUsed: "Suivi candidature", myMessage: "Léa, bonne journée ! Je me permets de te relancer concernant le poste d'Engineering Manager chez Qonto. Mon intérêt reste intact, le projet me parle vraiment.", interlocutorResponse: null, completedAt: "2026-05-25", createdAt: new Date("2026-05-20") },
  { id: "fu11", userId: "demo", contactId: "ct5", scheduledDate: "2026-05-10", status: "completed" as const, messageTemplateUsed: null, myMessage: "Arthur, j'ai vu votre post LinkedIn sur les infrastructures LLM — vraiment pertinent. Toujours en recherche d'un poste SRE côté AI infra, est-ce que Mistral recrute encore sur ce segment ?", interlocutorResponse: "Oui on a 2 postes ouverts ! Envoie-moi ton CV directement, je le transmets à Sarah en interne.", completedAt: "2026-05-10", createdAt: new Date("2026-05-05") },
  { id: "fu12", userId: "demo", contactId: "ct4", scheduledDate: "2026-04-18", status: "completed" as const, messageTemplateUsed: null, myMessage: "Thomas, je souhaitais faire un point suite à l'envoi de ma candidature pour le poste de Staff Engineer. Le projet de migration Kubernetes m'intéresse particulièrement.", interlocutorResponse: "On est encore en phase de définition du scope du poste, je te recontacte dans 3 semaines.", completedAt: "2026-04-18", createdAt: new Date("2026-04-12") },
  { id: "fu13", userId: "demo", contactId: "ct10", scheduledDate: "2026-04-05", status: "completed" as const, messageTemplateUsed: null, myMessage: "Bonjour Paul, suite à notre échange au meetup GopherParis, je vous envoie mon profil comme convenu.", interlocutorResponse: null, completedAt: "2026-04-05", createdAt: new Date("2026-04-01") },
  { id: "fu14", userId: "demo", contactId: "ct1", scheduledDate: "2026-03-22", status: "completed" as const, messageTemplateUsed: null, myMessage: "Sophie, je souhaitais vous relancer concernant ma candidature SRE envoyée il y a 2 semaines. Seriez-vous disponible pour un appel de 20 min cette semaine ?", interlocutorResponse: "Oui bien sûr ! Je vous propose jeudi 14h ou vendredi 10h. Lequel vous convient ?", completedAt: "2026-03-22", createdAt: new Date("2026-03-18") },
  { id: "fu15", userId: "demo", contactId: "ct3", scheduledDate: "2026-03-10", status: "completed" as const, messageTemplateUsed: null, myMessage: "Léa, j'ai vu l'offre EM publiée sur votre page careers. Mon profil colle bien avec ce que vous cherchez, ça vous dirait qu'on échange 15 min ?", interlocutorResponse: "Avec plaisir ! Je te forwarde le lien Calendly.", completedAt: "2026-03-10", createdAt: new Date("2026-03-06") },
  { id: "fu3", userId: "demo", contactId: "ct4", scheduledDate: "2026-06-01", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-12") },
  { id: "fu4", userId: "demo", contactId: "ct5", scheduledDate: "2026-06-03", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-28") },
  { id: "fu5", userId: "demo", contactId: "ct6", scheduledDate: "2026-06-08", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-10") },
  { id: "fu6", userId: "demo", contactId: "ct8", scheduledDate: "2026-06-10", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-05") },
  { id: "fu7", userId: "demo", contactId: "ct9", scheduledDate: "2026-06-12", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-18") },
  { id: "fu8", userId: "demo", contactId: "ct7", scheduledDate: "2026-04-25", status: "skipped" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-04-20") },
  { id: "fu9", userId: "demo", contactId: "ct1", scheduledDate: "2026-06-02", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-20") },
  { id: "fu10", userId: "demo", contactId: "ct10", scheduledDate: "2026-06-15", status: "pending" as const, messageTemplateUsed: null, myMessage: null, interlocutorResponse: null, completedAt: null, createdAt: new Date("2026-05-12") },
];
